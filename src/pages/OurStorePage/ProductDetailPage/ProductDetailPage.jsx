                    ...
                    <div className="col-12">
                        ...
                        <div className="bg-white p-3">
                            <p>
                                ...
                                adipisicing elit. Quam, harum vitae? Quisquam
                                quo sint nesciunt beatae assumenda aut explicabo
                                mollitia sunt at facilis, cum dolor ut
                                exercitationem nemo ipsum voluptate!
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="review-inner-wrapper">
                            ...
                            <div className="reviews mt-4">
                                <div className="review">
                                    ...
                                    <p className="mt-3">
                                        Lorem ipsum dolor sit amet consectetur
                                        adipisicing elit. Optio necessitatibus
                                        officiis sint vero laboriosam, commodi
                                        hic nam autem repellendus totam
                                        quibusdam consectetur neque maxime
                                        facilis, consequuntur magnam maiores
                                        excepturi ex!
                                    </p>
                                </div>
                            </div>
